...
INSERT INTO _0002_assertion VALUES (
    ...
    (SELECT
        ...
        AND (SELECT count(*) FROM oauth_refresh_tokens) = 2
        AND coalesce((SELECT state = 'rotated' AND replacement_token_id = 'rt2'
                      FROM oauth_refresh_tokens WHERE refresh_token_id = 'rt1'), 0)
