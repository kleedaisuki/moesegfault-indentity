...
const messages = {
  "zh-CN": {
    ...
    chooseAvatar: "选择头像", noAvatarSelected: "未选择文件", avatarProcessing: "正在优化头像…", avatarReady: "头像已优化，可上传", avatarProcessingFailed: "无法处理这张图片；将不上传头像。", avatarPreviewAlt: "即将上传的头像预览",
  ...
  en: {
    ...
    chooseAvatar: "Choose avatar", noAvatarSelected: "No file selected", avatarProcessing: "Optimizing avatar…", avatarReady: "Avatar optimized and ready", avatarProcessingFailed: "This image could not be processed; no avatar will be uploaded.", avatarPreviewAlt: "Preview of the avatar to be uploaded",
  ...
  ja: {
    ...
    chooseAvatar: "アバターを選択", noAvatarSelected: "ファイルが選択されていません", avatarProcessing: "アバターを最適化中…", avatarReady: "最適化したアバターをアップロードできます", avatarProcessingFailed: "画像を処理できませんでした。アバターはアップロードされません。", avatarPreviewAlt: "アップロードするアバターのプレビュー",
